...
public class Starter {
	...
	private static HashMap<String, Class<?>> applications() {
		...
		applications.put("platform_backend", PlatformBackendApplication.class);
	...
	private static HashMap<String, HashMap<String, Class<?>>> commands() {
		...
		commands.put("platform_backend", PlatformBackendApplication.commands());
	...
	private static void startRabbitConsumer(ConfigurableApplicationContext context) {
		RabbitMqDomainEventsConsumer consumer = context.getBean(RabbitMqDomainEventsConsumer.class);
		consumer.consume();
	}
}
