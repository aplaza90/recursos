package com.recursos.shared.infrastructure.bus.command;
...
import com.recursos.shared.domain.bus.command.CommandNotRegisteredError;
...
public final class CommandHandlersInformation {
    ...
    public CommandHandlersInformation() {
        Reflections                          reflections = new Reflections("com.recursos");
